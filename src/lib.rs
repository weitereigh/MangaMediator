// src/lib.rs
/*
 * Core library for MangaMediator
 */
...
#[derive(Debug)]
pub struct MangaMediatorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MangaMediatorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MangaMediator processing");
    
    let mut processor = MangaMediatorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MangaMediatorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MangaMediatorProcessor::new(false);
